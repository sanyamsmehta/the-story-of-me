      ...
      <div className="flex items-center gap-2 md:gap-3 mb-2 w-full relative z-20">
        {exp.logoUrl && (
          <img
            ...
            className="w-16 h-16 md:w-20 md:h-20 object-contain rounded border border-gray-200 bg-white shadow min-w-[4rem] min-h-[4rem] max-w-[5rem] max-h-[5rem] mr-2" // Added mr-2 to move logo slightly right
          />
        )}
