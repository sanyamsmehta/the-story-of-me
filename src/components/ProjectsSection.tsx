            ...
            >
              {project.github && (
                <a 
                  ...
                  className="absolute top-2 right-2 flex items-center gap-1 text-foreground hover:text-gray-600 transition-colors bg-white/80 rounded-full px-2 py-1 shadow-sm"
                >
                  <Github size={16} />
