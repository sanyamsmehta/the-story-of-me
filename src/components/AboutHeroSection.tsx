  ...
  <section id="about" className="section-padding bg-[#101010] flex items-center justify-center min-h-[600px] border-b border-muted">
    <div className="max-w-6xl w-full mx-auto px-6 flex flex-col md:flex-row gap-12 items-center animate-fade-in">
      ...
      <div className="flex flex-col items-center w-full md:w-2/5">
        {/* Profile Picture */}
        <div className="rounded-full overflow-hidden border-4 border-white/10 shadow-lg mb-5 w-56 h-56 bg-muted flex items-center justify-center">
          <img
            src={profilePhoto}
            alt="Sanyam Mehta"
        ...
        <div className="flex gap-5 mb-2">
          <a href={linkedIn} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
            ...
            <div className="bg-white p-1.5 rounded-full shadow-md border-2 border-[#0077b5] group-hover:bg-[#0077b5] group-hover:text-white transition">
              <Linkedin size={19} color="#0077b5" className="group-hover:text-white" />
            </div>
          </a>
          <a href={github} target="_blank" rel="noopener noreferrer" aria-label="GitHub"
            className="group hover:scale-105 transition-all duration-200">
            <div className="bg-white p-1.5 rounded-full shadow-md border-2 border-[#161b22] group-hover:bg-[#161b22] group-hover:text-white transition">
              <Github size={19} color="#181717" className="group-hover:text-white" />
            </div>
          </a>
          <a href={mail} target="_blank" rel="noopener noreferrer" aria-label="Email"
            className="group hover:scale-105 transition-all duration-200">
            <div className="bg-white p-1.5 rounded-full shadow-md border-2 border-gray-400 group-hover:bg-black group-hover:text-white transition">
              <Mail size={19} color="#202124" className="group-hover:text-white" />
            </div>
          </a>
          ...
          <a href={phoneNumber} aria-label="Phone" className="group hover:scale-105 transition-all duration-200">
            <div className="bg-white p-1.5 rounded-full shadow-md border-2 border-gray-400 group-hover:bg-[#0FA0CE] group-hover:text-white transition">
              <Phone size={19} color="#666" className="group-hover:text-white" />
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="w-full md:w-3/5 flex flex-col justify-center px-2">
        <div className="text-[#ececec] text-2xl font-semibold mb-6 font-sans">About Me</div>
        <div className="text-[0.98rem] md:text-base text-gray-200 leading-relaxed text-balance font-[400] font-inter" style={{fontFamily: "'Inter', 'Segoe UI', Arial, sans-serif"}}>
