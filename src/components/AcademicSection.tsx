...
const TimelineNode: React.FC<{ education: Education }> = ({ education }) => (
  <div className="relative group flex-shrink-0 w-64 md:w-52 lg:w-64">
    <div className="flex flex-col items-center">
      <div className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full bg-slate-300 p-1 shadow-xl transform group-hover:scale-110 transition-all duration-300">
  ...
  <section id="academic" className="section-padding bg-gradient-to-b from-gray-50 to-white">
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="relative">
        <div className="absolute top-6 left-0 right-0 h-1 bg-gradient-to-r from-slate-300 to-slate-400 transform -translate-y-1/2" />
        
        <div className="flex justify-between items-center gap-2 md:gap-4 overflow-x-auto py-4">
